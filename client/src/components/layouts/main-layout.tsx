...
export const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      {/* Header */}
      <header className="bg-[#FF385C] border-b border-gray-200">
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center">
              ...
              <nav className="hidden md:flex space-x-8">
                ...
                <Link href="/destinations" className="text-white/80 hover:text-white font-medium">Destinazioni</Link>
                <Link href="/contatti" className="text-white/80 hover:text-white font-medium">Contatti</Link>
              </nav>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-[#FF385C] py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <img src="https://yookye.com/wp-content/uploads/2023/12/Logo-yookye.svg" alt="Yookye" className="h-8 mb-6" />
              <p className="text-white/80 text-sm">Yookye è la piattaforma che ti permette di organizzare viaggi su misura in modo semplice e veloce.</p>
              <div className="mt-6 flex space-x-4">
                <a href="https://www.facebook.com/yookye" target="_blank" className="text-white/80 hover:text-white">
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a href="https://www.instagram.com/yookye" target="_blank" className="text-white/80 hover:text-white">
                  <i className="fab fa-instagram"></i>
                </a>
                <a href="https://www.linkedin.com/company/yookye" target="_blank" className="text-white/80 hover:text-white">
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/80">
                <li><a href="#" className="text-white/80 hover:text-white">Come funziona</a></li>
                <li><a href="#" className="text-white/80 hover:text-white">Destinazioni</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/80">
                <li><a href="#" className="text-white/80 hover:text-white">Chi siamo</a></li>
                <li><a href="#" className="text-white/80 hover:text-white">Lavora con noi</a></li>
                <li><a href="#" className="text-white/80 hover:text-white">Contatti</a></li>
            ...
            <div>
              ...
              <p className="text-white/80 mb-4">Iscriviti alla nostra newsletter per ricevere offerte esclusive</p>
              <div className="flex">
